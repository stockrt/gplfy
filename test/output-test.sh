...
it_creates_generic_c_license () {
    ...
    ret="$($tool -a "$author_name" -e $author_email -f c mycode.c | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
...
it_creates_generic_c_license_overwrite () {
    ...
    license_content="$(filter_file files/generic-LICENSE)"
    license_output_content="$(filter_file files/generic-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -o mycode.c | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_c_sublicense () {
    ...
    license_output_content="$(filter_file files/generic-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -s mycode.c | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_c_sublicense_overwrite () {
    ...
    license_content="$(filter_file files/generic-LICENSE.sublicense)"
    license_output_content="$(filter_file files/generic-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -o -s mycode.c | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_c_license () {
    ...
    ret="$($tool -a "$author_name" -e $author_email -f c mycode.c "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_c_license_overwrite () {
    ...
    license_content="$(filter_file files/specific-LICENSE)"
    license_output_content="$(filter_file files/specific-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -o mycode.c "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_c_sublicense () {
    ...
    license_output_content="$(filter_file files/specific-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -s mycode.c "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_c_sublicense_overwrite () {
    ...
    license_content="$(filter_file files/specific-LICENSE.sublicense)"
    license_output_content="$(filter_file files/specific-output-LICENSE.c)"
    ret="$($tool -a "$author_name" -e $author_email -f c -o -s mycode.c "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_sh_license () {
    ...
    ret="$($tool -a "$author_name" -e $author_email -f sh mycode.sh | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_sh_license_overwrite () {
    ...
    license_content="$(filter_file files/generic-LICENSE)"
    license_output_content="$(filter_file files/generic-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -o mycode.sh | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_sh_sublicense () {
    ...
    license_content="$(filter_file files/generic-LICENSE.sublicense)"
    license_output_content="$(filter_file files/generic-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -s mycode.sh | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_generic_sh_sublicense_overwrite () {
    ...
    license_content="$(filter_file files/generic-LICENSE.sublicense)"
    license_output_content="$(filter_file files/generic-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -o -s mycode.sh | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_sh_license () {
    ...
    ret="$($tool -a "$author_name" -e $author_email -f sh mycode.sh "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_sh_license_overwrite () {
    ...
    license_content="$(filter_file files/specific-LICENSE)"
    license_output_content="$(filter_file files/specific-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -o mycode.sh "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_sh_sublicense () {
    ...
    license_content="$(filter_file files/specific-LICENSE.sublicense)"
    license_output_content="$(filter_file files/specific-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -s mycode.sh "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
...
it_creates_specific_sh_sublicense_overwrite () {
    ...
    license_content="$(filter_file files/specific-LICENSE.sublicense)"
    license_output_content="$(filter_file files/specific-output-LICENSE.sh)"
    ret="$($tool -a "$author_name" -e $author_email -f sh -o -s mycode.sh "My Program" | tail -n +6 | head -n -1)"
    a="$(< AUTHOR)"
    c="$(< COPYING)"
    l="$(< LICENSE)"
    test "$ret" = "$license_output_content"
